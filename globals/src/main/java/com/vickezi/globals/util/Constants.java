...
public class Constants {
     ...
     */
    public static final String USER_EMAIL_REGISTRATION_CONFIRMATION_NOTICE_TOPIC = "user_registration_confirmation";
    public static final String EMAIL_VERIFICATION_MESSAGE_TOPIC ="email_registration_topic";
    public static final String SEND_USER_EMAIL_REGISTRATION_MESSAGE = "notify_user_for_email_registration_queue";
    /**
